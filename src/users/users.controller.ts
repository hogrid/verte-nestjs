...
export class UsersController {
  ...
  @ApiOperation({
    ...
    description:
      'Cria um novo cliente/usuário no sistema (apenas administradores).\n\n' +
      '**Requer autenticação**: Sim (JWT)\n' +
      '**Requer permissão**: Administrador\n\n' +
      '**Funcionalidades:**\n' +
      '- Cria usuário com senha criptografada (bcrypt)\n' +
      '- Define status "actived" e confirmed_mail = 1\n' +
      '- Cria automaticamente instância WhatsApp (Number)\n' +
      '- Valida unicidade de email\n' +
      '- Valida CPF ou CNPJ\n' +
      '- Permite definir plano (plan_id) ou deixar null\n' +
      '- Permite definir perfil (user ou administrator)\n\n' +
      '**Estrutura do response:**\n' +
      '- `message`: Mensagem de sucesso\n' +
      '- `data`: Objeto com o cliente criado',
  })
  @ApiBody({
